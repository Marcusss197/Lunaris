...
//
// GET  /api/organize-tags?q=cyberpunk&offset=0&limit=60&flagged=1&nsfw=1&withTags=1&exclude=anime,furry&sort=downloads
...
import { searchWallpapersForOrganize, bulkUpdateWallpapers, OrganizeSortBy } from "@/lib/db"
